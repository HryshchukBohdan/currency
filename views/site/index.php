                        ...
                        <div class="modal-content">
                            ...
                            <div style="text-align:center;margin: 0 auto;" class="modal-body">
                                ...
                                <div style="display: inline-block;margin-right:10px; width: 120px;vertical-align: top">
                                    <?php echo $form->field($model,'sum_from')->textInput(['type'=>'number','placeholder'=>'Сумма','onchange'=>'rateToSum()'])->label('Сумма:')?>
                                </div>

                                <div style="display: inline-block;width: 120px;vertical-align: top;">
                                    <?php echo $form->field($model,'rate')->textInput(['class'=>'avg form-control','placeholder'=>'Курс','onchange'=>'rateToSum()'])->label('Курс:')?>
                                </div>
                                ...
                                <div style="display: inline-block;margin-right:10px; width: 120px;vertical-align: top">
                                    <?php echo $form->field($model,'sum_to')->textInput(['placeholder'=>'Сумма','onchange'=>'sumToRate()'])->label('Сумма:')?>
                                </div>
                                <div style="display: inline-block;width: 120px;vertical-align: top">
