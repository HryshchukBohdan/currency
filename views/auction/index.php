        ...
        <div class="col-md-6">
            ...
            <?php $form = ActiveForm::begin(['class'=>'form-horizontal']); ?>
                ...
                <div style="display: inline-block;width: 210px;margin-right:5px;vertical-align: top;">
                    <?php echo $form->field($model,'rate')->textInput(['value' => $rate, 'onchange' => "conversionKursToSum($sum_from)"])->label('Курс')?>
                </div>
                <div style="display: inline-block;width: 210px;vertical-align: top; padding-bottom: 20px;">
                    <?php echo $form->field($model,'sum_to')->textInput(['value' => ($sum_from * $rate), 'onchange' => "conversionSumToKurs($sum_from)"])->label('Сумма')?>
                </div>
