    ...
    <div class="row"">
        <div class="col-md-6">
            ...
            <?php $form = ActiveForm::begin(['class'=>'form-horizontal']); ?>
                <p style="margin-bottom: 20px;text-align: center;font-weight: bold;font-size: 16px;">Даные предложения:</p>
                ...
                <div style="display: inline-block;width: 210px;margin-right:5px;vertical-align: top;">
                    <?php echo $form->field($model,'rate')->textInput(['value' => $rate_new, 'onchange' => "conversionKursToSum($sum_from)"])->label('Курс')?>
                </div>
                <div style="display: inline-block;width: 210px;vertical-align: top;">
                    <?php echo $form->field($model,'sum_to')->textInput(['value' => ($sum_from_new), 'onchange' => "conversionSumToKurs($sum_from)"])->label('Сумма')?>
                </div>
